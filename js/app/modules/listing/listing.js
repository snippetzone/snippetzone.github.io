...
function (_React$Component3) {
  ...
  function MentorCardList() {
    ...
    _defineProperty(_assertThisInitialized(_this2), "getSearchBar", function () {
      return React.createElement("div", {
        className: "container"
      }, React.createElement("div", {
        className: "search-container row"
      }, React.createElement("div", {
        className: "title col-sm-12 col-md-8"
      }, "Collection"), React.createElement("div", {
        className: "search-input col-sm-12 col-md-4"
      }, React.createElement("div", {
        ...
        placeholder: "Search by designer or article title",
        "aria-label": "Search by designer or article title",
        "aria-describedby": "search-icon"
      })))));
    });

    _defineProperty(_assertThisInitialized(_this2), "getLoadMoreCTA", function () {
      return React.createElement("div", {
        className: "container"
      }, React.createElement("div", {
        ...
        href: "#",
        role: "button",
        className: "see-all-cta btn btn-outline-dark btn-block"
  ...
  _createClass(MentorCardList, [{
    key: "render",
    value: function render() {
      return React.createElement(React.Fragment, null, this.getSearchBar(), React.createElement("div", {
        className: "container mendor-listing-container"
      }, React.createElement("div", {
        className: "row"
      }, this.getMendorListing())), this.getLoadMoreCTA());
    }
  }]);
...
document.addEventListener("DOMContentLoaded", function () {
  var domContainer = document.getElementById("all-listing-container");
  var mendorList = preloadData("preloaded-listing-data");
